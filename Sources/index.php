...
<!--
                    ...
                    </div><!--/.col-md-4                </div><!--/.services            </div><!--/.row-->    
        <!--</div><!--/.container    </section><!--/#feature
    <section id="recent-works">
        <div class="container">
            ...
            </div><!--/.row        </div><!--/.container    </section><!--/#recent-works
    <section id="services" class="service-item">
	   <div class="container">
            <div class="center wow fadeInDown">
                <h2>Our Service</h2>
            ...
            </div><!--/.row        </div><!--/.container    </section><!--/#services
    <section id="middle">
        <div class="container">
            <div class="row">
            ...
            </div><!--/.row        </div><!--/.container    </section><!--/#middle
    <section id="content">
        <div class="container">
            <div class="row">
            ...
            </div><!--/.row        </div><!--/.container    </section><!--/#content
    <section id="partner">
        <div class="container">
            <div class="center wow fadeInDown">
                <h2>Our Partners</h2>
